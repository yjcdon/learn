...
public class ProcessServiceImpl implements ProcessService {
    ...
    public String notPass() {
        StateHandler stateHandler = processHandlerFactory.getStateHandler(ProcessEnum.REJECT.getName());
        RejectContext rejectContext = new RejectContext();
        rejectContext.setStateName(ProcessEnum.REJECT.getName());
        stateHandler.reject(rejectContext);
        return ProcessEnum.REJECT.getDesc() + "完成";
    }
}
